...
function init() {
    ...
    document.getElementById("rotate-top-right").addEventListener("click", rotateTopRight);
    document.getElementById("rotate-bottom-left").addEventListener("click", rotateBottomLeft);
    document.getElementById("rotate-bottom-right").addEventListener("click", rotateBottomRight);
    document.getElementById("rotate-center").addEventListener("click", rotateCenter);
    document.getElementById("rotate-top-left").addEventListener("click", rotateTopLeft);
